...
console.log(`<svg width="1000" height="auto" viewBox="-800 -800 1600 1600" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
        ...
        <mask id="rect-boxsize">
            <rect x="-3000" y="-3000" width="6000" height="6000" fill="black" />
            <rect x="-444" y="-700" width="888" height="1400" fill="white" />
        </mask>
    </defs>
    <g mask="url(#rect-boxsize)">
    ...
    <rect x="-444" y="-700" width="888" height="1400" stroke="#DEADBF" stroke-width="1.00" />
